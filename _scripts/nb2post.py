...
#export2html.notebook2html(fname='../_notebooks/*.ipynb', dest='../_posts/', template_file='fastpages.tpl', execute=False)
exporter=export2html.nbdev_exporter(template_file='notebook.tpl')
exporter.template_paths.append(str(Path(__file__).parent/'templates'))
export2html.notebook2html(fname='notebooks/*.ipynb', dest='_posts/', 
                          n_workers=0,
                          exporter=exporter,
                          template_file='notebook.tpl', execute=False)
